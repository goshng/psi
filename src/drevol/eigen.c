...
complex cmpl (double re,double im)
{
    complex r;
      ...
      for (en = n-1; en >= 0; en--) {
         ...
         if ((q = vali[en]) < 0) {            /* complex vector */
            ...
            if (fabs(mat[pos(en,en-1,n)]) > fabs(mat[pos(en-1,en,n)])) {
               ...
               v = cdiv(cmpl(0.0,-mat[pos(en-1,en,n)]),
                    cmpl(mat[pos(en-1,en-1,n)]-p,q));
            ...
            for (i = en - 2; i >= 0; i--) {
               ...
               if (vali[i] < 0) {
                  ...
                  if (vali[i] == 0) {
                     ...
                     v = cdiv(cmpl(x*r-z*ra+q*sa,x*s-z*sa-q*ra),v);
                     mat[pos(i,en-1,n)] = v.re;
                     mat[pos(i,en,n)] = v.im;
                     if (fabs(x) > fabs(z) + fabs(q)) {
                        ...
                        v = cdiv(cmpl(-r-y*mat[pos(i,en-1,n)],
                             -s-y*mat[pos(i,en,n)]),cmpl(z,q));
